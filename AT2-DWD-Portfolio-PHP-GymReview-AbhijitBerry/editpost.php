...
<main class="container mt-3" style="width: 1000px">
  <?php
  // 1. Check User is Logged In + 2. Id passed in via GET
  if (isset($_SESSION['userId']) && isset($_GET['id'])) {
    ...
    $sql = "SELECT title, imageurl ,comment, websiteurl, websitetitle, reviewer FROM posts WHERE id=?";
  ...
  <form action="includes/editpost.inc.php?id=<?php echo $id ?>" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" name="reviewer" placeholder="reviewer" value="<?php echo $row['reviewer'] ?>">
    </div>
    ...
    <!-- 7. SUBMIT BUTTON -->
    <button type="submit" name="edit-submit" class="btn btn-primary w-100">Submit</button>
  </form>
</main>
