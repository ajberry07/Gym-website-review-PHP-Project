...
<head>
  ...
  <title>Melbourne Gym Reviews</title>
</head>
...
<body>
  <nav id="navbar">
    <ul class="nav justify-content-center">
      ...
      ?>
      <!-- CONDITIONAL "Upload Images": Check global $_SESSION variable to see if user is logged in -->
  ...
  <header class="container">
    <div id="logo" class="text-center">
      <img src="./images/logo2.png" alt="gym-logo">
      <h1 class="text-center">Melbourne Gym Reviews</h1>
      <h6>Your trusted place to find the best gyms in Melbourne </h6>
    </div>
  ...
  <div class="container mt-3" style="width: 1000px">
    ...
    if (isset($_GET['loginerror'])) {
      ...
      if ($_GET['loginerror'] == "emptyfields") {
        ...
        $errorMsg = "Unsuccessful Login: The user does not exist";
      }
